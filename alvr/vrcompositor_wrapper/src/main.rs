...
fn main() {
    ...
    // std::env::set_var("VK_LAYER_PATH", format!("/nix/store/kkjh67yavmh060jxzq6skxnaqs58ia7p-vulkan-tools-lunarg-1.3.231.0/etc/vulkan/explicit_layer.d:/nix/store/yn86szvdpgx5w9aylbdw4ial5mqdq524-vulkan-validation-layers-1.3.224.0:{}",layer_path.to_str().unwrap()));
